...
verb <- read.table("NIADic/inst/dics/verb.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE,colClasses='character')
verb$cate <- 'verb'

brand_name <- read.table("NIADic/inst/dics/brand_name.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
brand_name$cate <- 'brand_name'

general_product <- read.table("NIADic/inst/dics/general_product.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
general_product$cate <- 'general_product'

people_names <- read.table("NIADic/inst/dics/people_names.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE,colClasses='character')
people_names$cate <- 'people_names'

people_general <- read.table("NIADic/inst/dics/people_general.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
people_general$cate <- 'people_general'

proper_noun <- read.table("NIADic/inst/dics/proper_noun.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
proper_noun$cate <- 'proper_noun'


place_name <- read.table("NIADic/inst/dics/place_name.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
place_name$cate <- 'place_name'

place_general <- read.table("NIADic/inst/dics/place_general.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
place_general$cate <- 'place_general'


general_tag_collect <- read.table("NIADic/inst/dics/general_tag_collect.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
general_tag_collect$cate <- 'general_tag_collect'


special_characters <- read.table("NIADic/inst/dics/special_characters.tsv", sep='\t', fileEncoding='UTF-8', header=FALSE, colClasses='character')
special_characters$cate <- 'special_characters'
...
h_tag=c('보통명사', '동사', '부사', '연결어미', '종결어미', '감탄사', '격조사', '수사', '의존명사', '관형사', '전성어미', '대명사', '외국어', '기타기호', '접미사', '선어말어미', '보조사', '쉼표', '여는 따옴표 또는 묶음표', '단위기호', '이음표'), stringsAsFactors=F)
...
setnames(one_dic,c("term",'tag', 'insight_cate'))
...
save(j_one_dic, file='insighter_dic.RData')
